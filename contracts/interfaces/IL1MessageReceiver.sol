...
interface IL1MessageReceiver is ILayerZeroReceiver {
    /**
    ...
    /**
     * The function to get the rewardToken contract address.
     * @return The address of the rewardToken contract.
     */
    function rewardToken() external view returns (address);

    /**
     * The function to set the params.
     * @param disctribution_ The address of the rewardToken contract.
     * @param config_ The config data.
     */
    function setParams(address disctribution_, Config calldata config_) external;
